...
public final class GetMockProductsUtils {
    public static Set<Product> getMockProducts() {
        return  Set.of(
                ...
                new Product(null, "Notebook", new BigDecimal("2800.15"), Set.of(Category.ELETRONICS), null),
                new Product(null, "Fridge", new BigDecimal("1500.15"), Set.of(Category.ELETRONICS), null)
        );
    }
